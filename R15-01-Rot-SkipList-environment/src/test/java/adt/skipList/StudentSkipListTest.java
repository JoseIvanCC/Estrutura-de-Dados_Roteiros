...
public class StudentSkipListTest {
	...
	@Test
	public void testElementsByHeight() {
		skip.insert(10, "A", 2);
		skip.insert(20, "B", 1);
		skip.insert(0, "C", 1);
		skip.insert(15, "D", 3);
		...
		System.out.println(Arrays.toString(skip.elementsByHeight(1)));
	}
	
	@Test
	public void testElementsByHeightDescrescente() {
		skip.insert(10, "A", 2);
		skip.insert(20, "B", 1);
		skip.insert(0, "C", 1);
		skip.insert(15, "D", 3);
		...
		Integer[] arrayDecrescente = { 15, 5, 10, 0, 20 };

		System.out.println(Arrays.toString(skip.elementsByHeightDescrescente()));
	}

	@Test
	public void testIsLevelOk() {
		skip.insert(10, "A", 2);
		skip.insert(20, "B", 1);
		skip.insert(0, "C", 1);
		skip.insert(15, "D", 3);
		...
		assertEquals(true, skip.isLevelOk());
	}
...
//		skip.insert(14, "H", 1);
//		String[] array = { "A", "C", "G" };
//		String result = Arrays.toString(((SkipListImpl<String>) skip).elementsByLevel(2));
