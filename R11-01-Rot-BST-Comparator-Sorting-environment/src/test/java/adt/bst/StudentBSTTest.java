...
public class StudentBSTTest {
	...
	public void testSort() {
		Integer[] array = { };
		Integer[] arrayOrdenado = { };
		assertEquals(Arrays.toString(((SortComparatorBSTImpl<Integer>) tree).sort(array)), Arrays.toString(arrayOrdenado));
	}
	
	@Test
	public void testReverseOrder() {
		fillTree();
		Integer[] array = { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		assertEquals(Arrays.toString(((SortComparatorBSTImpl<Integer>) tree).reverseOrder()), Arrays.toString(array));
	}
